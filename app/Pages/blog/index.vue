...
<template>
  ...
  <section class="relative h-[400px] lg:h-[500px] overflow-hidden group">
    <!-- Background -->
    <img src="/images/banner6.jpg" alt="Tech products banner"
    ...
    <div class="container h-full mx-auto px-4 flex items-center justify-center relative z-10">
      <div class="max-w-5xl space-y-4">
        ...
        <h1 class="text-5xl md:text-7xl font-secondary text-center font-bold text-white leading-tight tracking-tight">
          <span class="linear-wipe drop-shadow-lg">Latest News & Blog </span>
        </h1>
      ...
      <div class="flex flex-wrap lg:py-5">
        ...
        <div class="w-full lg:w-3/4 rounded-lg px-4">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            <BlogCard v-for="blogs in blogs.data" :key="blogs.id" :blogs="blogs" />
          </div>
        </div>
        ...
        <div class="w-full lg:w-1/4 lg:pb-10">
          <!-- Top Articles -->
          <div class="bg-gradient-to-br from-gray-50 to-white p-6 shadow-lg border border-gray-100 mb-8">
            <h2
            ...
            <div v-for="blog in topblogs?.data" :key="blog.id"
              ...
              <div class="relative overflow-hidden w-20 h-16 flex-shrink-0">
                <img class="w-full h-full object-cover group-hover/item:scale-110 transition-transform duration-500"
                  :src="blog?.thumbnail" alt="Blog Image" />
                <div
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="text-xs font-secondary text-gray-600 gap-3">
                  ...
                  <span class="flex items-center gap-1">
                    ...
                    {{
                      blog?.total_review > 0
                        ? `${blog?.total_review} review${blog?.total_review > 1 ? "s" : ""
                        }`
                        : "No reviews"
                    }}
                  </span>
