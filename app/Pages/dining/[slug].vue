...
type SingleDiningApiResponse = {
  data: Dining;
}
const { data: dining } = useAPI < SingleDiningApiResponse > (`/get-dining/${useRoute().params?.slug}`);
</script>
  ...
  <section class="">
    <div class="relative h-[400px] lg:h-[500px] overflow-hidden">
      <div class="absolute inset-0">
        <img :src="dining?.data?.image" alt="Dining Image" class="w-full h-full object-cover transform scale-105" />
          ...
          <div class="flex items-center gap-6 flex-wrap">
            <div class="flex font-secondary items-center gap-3">
              ...
              <div class="text-gray-300">
                <p class="text-sm">{{ dining?.data?.price_note }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="flex flex-col lg:flex-row gap-12">
        ...
        <div class="w-full lg:w-1/3 space-y-8">
          ...
          <div class="bg-white shadow-2xl p-6">
            ...
            <div class="space-y-5">
              <div v-for="related_dining in dining?.data?.latest_dining" :key="related_dining.id"
                ...
                <NuxtLink :to="`/dining/${related_dining.slug}`" class="flex gap-4">
                  <img :src="related_dining.image"
